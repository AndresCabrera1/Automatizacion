...
public class BotonesCalculadora {
    ...
    public static final Target TXT_NUMEROCALCULADORA = Target.the("presiona la tecla {0} ").locatedBy("//*[@resource-id ='com.android.calculator2:id/digit_{0}']");
    ...
    public static final Target TXT_RESULTADO = Target.the("Obtiene los resultados de la operacion realizada").located(By.id("result"));
